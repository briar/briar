...
public class StartupViewModelTest extends BrambleMockTestCase {
	...
	private final FakeTelegramAuthSession telegramAuthSession =
			new FakeTelegramAuthSession();
	private StartupViewModel viewModel;

	public StartupViewModelTest() {
	...
	public void setUp() {
		...
		LifecycleManager lifecycleManager = context.mock(LifecycleManager.class);
		...
		viewModel = new StartupViewModel(app, accountManager, lifecycleManager,
				notificationManager, eventBus, new ImmediateExecutor(),
	...
	private static class FakeTelegramAuthSession implements TelegramAuthSession {
		...
		public RecoverableErrorDetail getRecoverableErrorDetail() {
			return RecoverableErrorDetail.NONE;
		}
